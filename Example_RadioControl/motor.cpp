...
/*!
  ...
  \param[in]
  leftpwm   linker Motor (-r�ckwaerts, + vorwaerts) (Wertebereich -128...127)

  \param[in]
  rightpwm  rechter Motor (-r�ckwaerts, + vorwaerts)  (Wertebereich -128...127)
  ...
  // und f�r den rechten Motor auf -60 (rueckwaerts)
