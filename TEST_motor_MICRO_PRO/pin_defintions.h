...
#ifdef ARDDUINO_NANO
#define MOTOR_RIGHT1     2 // dout, L293D pin7, motor driver right side, half bridge 1
#define MOTOR_RIGHT2     3 // dout, L293D pin2, motor driver right side, half bridge 2
...
#define MOTOR_LEFT2      A2  // dout, L293D pin15, motor driver left side half bridge 2
#define MOTOR_LEFT1      A3  // dout, L293D pin10, motor driver left side half bridge 1
